<?php
// index.php -- Live OCPP WS Log with 3 tables:
//   1) BootNotification CALLs
//   2) Other CALLs (msg[0]===2)
//   3) CALLRESULTs (msg[0]===3)
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .header {
      ...
      padding: 1rem; font-size: 1.25rem; flex-shrink: 0;
    }
    .content {
    ...
    #detail {
      border-left: 1px solid #e0e0e0; background: #fafbfc;
    }
    .entry {
      margin-bottom: .5rem;
      font-family: monospace; line-height:1.4; word-wrap:break-word;
    }
    .entry .ts {
      color:#888; margin-right:.5rem; font-size:.85em;
    }
    .entry.status {
      font-style:italic; color:#555;
    }
    .subheader {
      font-weight:bold; margin-top:1rem; font-size:1.2rem; margin: 1rem 0; 
    }
    table {
      width:100%; border-collapse:collapse;
      margin: .5rem 0; font-family:monospace; font-size:.9rem;
    }
    th,td {
...
<body>
  <div class="container">
    <div class="header">OCPP Live Data Log</div>
    <div class="content">
      <div id="log">
  ...
  (function(){
    ...
    function setLatest(tbodyRaw, tbodyDesc, raw){
      ...
      // Break out JSON into name/value in tbodyDesc
      tbodyDesc.innerHTML = '';
      let obj;
